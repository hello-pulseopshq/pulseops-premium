...
Every flagship chapter must produce:

Approved Desktop Mockup (image)
Approved Mobile Mockup (image)
Annotated Desktop Mockup (same image with numbered callouts)
Annotated Mobile Mockup (same image with numbered callouts)

Supporting annotation text may accompany the images, but the annotated images are the primary implementation artifact.
